...
export interface ISelectLanguageProps extends ISelectProps {}
...
const SelectLanguage = ({
  ...
  const [selectedLang, setSelectedLang] = useState<ISelectLanguageProps>(
    options[0]
  )
  ...
  return isMounted ? (
    <div
      className={cn('flex items-center rounded-full border px-3', className)}
      style={{
    ...
    >
      ...
      <Select
        ...
        onChange={(selectedOption) =>
          setSelectedLang(selectedOption as ISelectLanguageProps)
        }
      />
    </div>
  ) : null
